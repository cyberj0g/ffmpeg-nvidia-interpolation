...
/**
* Minimun number of resource NvOFFRUC should get registered with before NvOFFRUCProcess call occurs
*/
...
typedef struct _NvOFFRUC_FRAMEDATA
{
    ...
    bool*                   bHasFrameRepetitionOccurred;  /**< [out]: flag to indicate whether frame repetition has occurred */
    uint32_t                uiReserved[32];
}NvOFFRUC_FRAMEDATA;
...
/**
* \struct NvOFFRUC_UNREGISTER_RESOURCE_PARAM
* Parameters for unregistering a resource with NvOFFRUC
...
* ::NvOFFRUC_ERR_GENERIC \n
*/
typedef NvOFFRUC_STATUS(CALLBACK* PtrToFuncNvOFFRUCProcess)(NvOFFRUCHandle, NvOFFRUC_PROCESS_IN_PARAMS*, NvOFFRUC_PROCESS_OUT_PARAMS*);

/**
* \brief Release NvOFFRUC API and resources.
*
